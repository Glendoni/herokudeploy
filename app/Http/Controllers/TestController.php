...
where P.parent_id=1');
    ...
    function yes(){
          ...
          $out  = DB::select('select dt.updated_by_id, ds.* from default_users_users ds
LEFT JOIN default_pages_pages_translations dt
ON ds.id = dt.updated_by_id');
            $out  = DB::select('SELECT id, created_at,updated_at, 
    ...
    "lname": "MY PROJ",
    "name": "Glen",
    "description": "<p>The Test Project</p>",
    "id": 10886789,
    "creationDate": null,
    "version": "2.9",
    "metrics": [{
